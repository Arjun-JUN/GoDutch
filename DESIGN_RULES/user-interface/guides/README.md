...
> The visual language rules that every Slate component follows.

## Overview

These guides encode the "why" behind Slate's visual decisions. Components implement these rules in code — these docs explain the principles so you can apply them when composing components or reviewing designs.

Read the guide for the area you're working in:
...
| [spacing-and-rhythm.md](spacing-and-rhythm.md) | 4-point grid, generous breath, spacing tokens |
